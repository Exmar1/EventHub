	...
	<header className="sticky top-0 z-50 bg-white border-b border-gray-50">
		<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			...
			<div className="flex flex-col items-center pb-6 gap-4">
				<div className="flex h-11 w-full max-w-[600px] items-center overflow-hidden rounded-xl border border-gray-200 bg-white px-4 shadow-sm transition-all focus-within:border-blue-400 focus-within:shadow-md">
					<input
						type="text"
						id="input"
						name="text"
